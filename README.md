...
This is a work-in-progress cell simulation built with Python and PyQt5. You can observe cells as they live, move, eat, divide, and evolve in a contained environment. Also functions as a good CPU and GPU stress tester (just click "Random" a few times and let it run!)
